    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // WebSocket handshake stays open (browsers can't set headers on
                        // the upgrade request); JwtStompChannelInterceptor enforces the
                        // bearer token on the STOMP CONNECT frame instead.
